      ...
      <div className="w-full max-w-md space-y-8 p-8 bg-[#111113] rounded-2xl border border-zinc-800 shadow-2xl">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-zinc-400">
            Sign in to your AgileFlow account
          </p>
        </div>
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-[#111113] text-zinc-500">
                Or continue with
              </span>
            </div>
          </div>
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center px-4 py-2 border border-zinc-700 rounded-lg shadow-sm bg-zinc-900 text-sm font-medium text-white hover:bg-zinc-800 transition-colors disabled:opacity-50"
            >
